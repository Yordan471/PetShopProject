        ...
        private List<Product> SeedProductsToDb()
        {
            ...
            var products = new List<Product>()
            {
                ...
                new Product
                {
                    ...
                    LongDescription = "Пълноценна суха храна за котки над 1 година, живеещи предимно на закрито. Помага за поддържане на идеално тегло и здравето на пикочните пътища.",
                    ShortDescription = "Суха храна за котки живеещи на закрито",
                    Price = 45.99m,
                    Quantity = 500,
                    ImageUrl = "~/Images/Products/Cats/DryFoods/Royal_Canin_Indoor_Cat.jpg",
                    AnimalType = "Котка",
                    CategoryId = 1
                },
                new Product
                {
                    Id = 27,
                    Name = "Hill's Science Plan Adult Optimal Care",
                    LongDescription = "Висококачествена суха храна за котки от 1 до 6 години с пиле. Поддържа здравето на кожата и козината, и подпомага храносмилането.",
                    ShortDescription = "Суха храна за възрастни котки",
                    Price = 39.99m,
                    Quantity = 500,
                    ImageUrl = "~/Images/Products/Cats/DryFoods/Hills_Science_Plan_Adult_Optimal_Care.jpg",
                    AnimalType = "Котка",
                    CategoryId = 1
                },
                new Product
                {
                    ...
                    LongDescription = "Пълноценна суха храна за кастрирани котки. Съдържа пуешко месо и е с намалено съдържание на мазнини за поддържане на идеално тегло.",
                    ShortDescription = "Суха храна за кастрирани котки",
                    Price = 42.99m,
                    Quantity = 500,
                    ImageUrl = "~/Images/Products/Cats/DryFoods/Purina_Pro_Plan_Sterilised.jpg",
                    AnimalType = "Котка",
                    CategoryId = 1
                                },
                new Product
                {
                    Id = 29,
                    Name = "Whiskas Adult",
                    LongDescription = "Пълноценна и балансирана суха храна за котки над 1 година с високо съдържание на пилешко месо. Поддържа естествените защитни сили на организма.",
                    ShortDescription = "Суха храна за възрастни котки с пиле",
                    Price = 24.99m,
                    Quantity = 500,
                    ImageUrl = "~/Images/Products/Cats/DryFoods/whiskas_adult.jpg",
                    AnimalType = "Котка",
                    CategoryId = 1
                },
                new Product
                {
                    Id = 30,
                    Name = "Animonda Carny Adult",
                    LongDescription = "Висококачествена суха храна за възрастни котки с говеждо, пуешко и заешко месо. Без зърнени съставки и с добавен таурин за здраво сърце.",
                    ShortDescription = "Суха храна за възрастни котки",
                    Price = 37.99m,
                    Quantity = 500,
                    ImageUrl = "~/Images/Products/Cats/DryFoods/animonda_carny_adult.jpg",
                    AnimalType = "Котка",
                    CategoryId = 1
                },
                new Product
                {
                    Id = 31,
                    Name = "Royal Canin Instinctive в желе",
                    LongDescription = "Пълноценна консервирана храна за котки над 1 година в желе. Поддържа идеално тегло и жизненост благодарение на балансираното съдържание на хранителни вещества.",
                ...
                {
                    Id = 32,
                    Name = "Whiskas Adult с пиле в сос",
                    LongDescription = "Пълноценна консервирана храна за възрастни котки с високо съдържание на пилешко месо в сос. Осигурява балансирано хранене и поддържа здравето на уринарния тракт.",
                ...
                {
                    Id = 33,
                    Name = "Purina Felix Fantastic с говеждо в желе",
                    LongDescription = "Консервирана храна за котки с апетитни парченца говеждо месо в желе. Съдържа всички необходими хранителни вещества за здраве и жизненост.",
                ...
                {
                    Id = 34,
                    Name = "Animonda Vom Feinsten Adult с пуешко и заешко",
                    LongDescription = "Висококачествена консервирана храна за възрастни котки с пуешко и заешко месо. Без зърнени съставки, изкуствени оцветители и консерванти.",
                    ShortDescription = "Консервирана храна за възрастни котки",
                    Price = 3.29m,
                    Quantity = 500,
                ...
                new Product
                {
                    ...
                    LongDescription = "Пълноценна консервирана храна за възрастни котки с риба тон. Поддържа здравето на кожата и козината, и подпомага функцията на уринарния тракт.",
